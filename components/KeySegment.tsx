...
const KeySegment = ({ label, fileName, segment }: KeySegmentProps) => {
    ...
    return <Box sx={columnStyle}>
        ...
        <Button color="inherit" variant="outlined" startIcon={<FileDownloadIcon />} download={fileName} href={"data:application/x-pem-file;base64," + Buffer.from(segment).toString("base64")}>Herunterladen</Button>
