...
interface DelegationProps {
    initDelegationDomain: ModelDomain;
    onClose: (domain: ModelDomain) => void;
}

const DelegationModal = ({ initDelegationDomain, onClose }: DelegationProps) =>{
    const style = {
        position: "absolute",
        top: "50%",
        left: "50%",
    ...
    const [delegationDomain, setDelegationDomain] = useState(initDelegationDomain);
