...
export default function ServerCertificatesCsr() {
    ...
    const column = { flex: "auto", minWidth: "49%", maxWidth: "100%", display: "flex", maxHeight: "100%", minHeight: "49%", pt: "5px", gap: "5px", flexDirection: "column", alignContent: "flex-start" };
